...
const getSelectClassName = (isDarkMode) => `
  h-12 w-full border-2 rounded-lg px-4 transition-colors cursor-pointer
  ${isDarkMode
...
const FilterPanel = ({
  ...
  const selectClassName = getSelectClassName(isDarkMode);
